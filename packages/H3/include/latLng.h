...
#define EPSILON_DEG 0.000000001  // Epsilon of ~0.1mm in degrees.
#define EPSILON_RAD (EPSILON_DEG * M_PI_180)  // Epsilon of ~0.1mm in radians.
...
double normalizeLng(const double lng, const LongitudeNormalization normalization);

bool geoAlmostEqual(const LatLng *p1, const LatLng *p2);
bool geoAlmostEqualThreshold(const LatLng *p1, const LatLng *p2, double threshold);
