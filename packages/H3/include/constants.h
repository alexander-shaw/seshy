...
#define M_2PI 6.28318530717958647692528676655900576839433  //  2*PI

#define M_PI_180 0.0174532925199432957692369076848861271111  // PI/180
#define M_180_PI 57.29577951308232087679815481410517033240547  // 180/PI

#define EPSILON 0.0000000000000001  // Threshold epsilon.

#define M_SQRT3_2 0.8660254037844386467637231707529361834714  // sqrt(3) / 2.0

#define M_SIN60 M_SQRT3_2  // sin(60')
#define M_RSIN60 1.1547005383792515290182975610039149112953  // 1/sin(60')

#define M_ONETHIRD 0.333333333333333333333333333333333333333  // 1/3

#define M_ONESEVENTH 0.14285714285714285714285714285714285  // 1/7
